...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'jmbo_facebook.page': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Page', '_ormbases': ['jmbo.ModelBase']},
            'access_token': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'facebook_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'jmbo_facebook.update': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Update', '_ormbases': ['jmbo.ModelBase']},
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
